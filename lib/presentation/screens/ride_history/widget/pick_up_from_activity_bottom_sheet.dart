...
class PickUpRiderFromActivityBottomSheet extends StatelessWidget {
  final RideModel ride;
  const PickUpRiderFromActivityBottomSheet({super.key, required this.ride});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<RideActionController>(
      builder: (controller) {
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                HeaderText(
                  text: MyStrings.passengerOtpVerification,
                ...
                Column(
                  children: [
                    ...
                    RoundedButton(
                      ...
                      isLoading: controller.isPickupLoading && controller.selectedRideId == ride.id,
                      ...
                      press: () async {
                        if (controller.otpController.text.isNotEmpty) {
                          ...
                          CustomSnackBar.error(
                            errorList: [MyStrings.pleaseEnterValidOtpCode.tr],
                          );
                        }
                      },
                    ),
